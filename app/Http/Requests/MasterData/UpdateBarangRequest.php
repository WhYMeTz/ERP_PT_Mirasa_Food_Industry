...
class UpdateBarangRequest extends FormRequest
{
    ...
    /**
     * Aturan validasi untuk proses pembaruan data barang.
     *
    ...
    public function rules(): array
    {
        ...
        return [
            'barang_cd' => [
                ...
                'string',
                'max:50',
                Rule::unique('mst_barang', 'barang_cd')->ignore($barangId, 'barang_id'),
            ],
            'barang_nm' => [
                'required',
                'string',
    ...
    public function messages(): array
    {
        return [
            ...
            'barang_cd.unique'   => 'Kode barang ini sudah digunakan oleh barang lain. Silakan gunakan kode lain.',
